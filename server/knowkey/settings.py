...
CSRF_TRUSTED_ORIGINS = [os.getenv("DJANGO_ALLOWED_DOMAIN", "http://localhost")]

SESSION_COOKIE_DOMAIN = os.getenv("DJANGO_ALLOWED_DOMAIN", "http://localhost")
SESSION_COOKIE_SECURE = True
SESSION_COOKIE_SAMESITE = "Lax"
CSRF_COOKIE_DOMAIN = os.getenv("DJANGO_ALLOWED_DOMAIN", "http://localhost")
CSRF_COOKIE_SECURE = True
CSRF_COOKIE_SAMESITE = "Lax"

CORS_ALLOWED_ORIGINS = [os.getenv("DJANGO_ALLOWED_DOMAIN", "http://localhost")]
